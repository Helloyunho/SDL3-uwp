    ...
    const SDL_GPUColorTargetDescription *colorTargets)
{
    ...
    for (Uint32 i = 0; i < numColorTargets; i += 1) {
        SDL_GPUColorComponentFlags colorWriteMask = colorTargets[i].blend_state.enable_color_write_mask ? colorTargets[i].blend_state.color_write_mask : 0xF;
    ...
    const SDL_GPUGraphicsPipelineCreateInfo *createinfo)
{
    ...
    pipeline->sampleMask = createinfo->multisample_state.enable_mask ? createinfo->multisample_state.sample_mask : 0xFFFFFFFF;
